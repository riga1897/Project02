...
class UINavigation:
    ...
    def paginate_display(
        ...
        while True:
            ...
            self._display_page(
                items, current_page, total_pages, 
                formatter, header, show_numbers
            )
            ...
            new_page = self._handle_navigation_choice(
                choice, current_page, total_pages, custom_actions
            )
...
def quick_paginate(
    ...
    navigator.paginate_display(
        items, formatter, header, show_numbers, custom_actions
    )
