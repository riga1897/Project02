...
class TestSuperJobParser:
    ...
    def test_parse_vacancies_with_value_error(self, mock_logger):
        ...
        vacancies_data = [{"invalid": "data"}]  # Неверная структура данных
    ...
    def test_parse_vacancies_with_exception(self, mock_logger):
        ...
        vacancies_data = [{"id": "123", "profession": "Test"}]
    ...
    def test_parse_vacancies_logs_info(self, mock_logger):
        ...
        vacancies_data = [
            {"id": "123", "profession": "Python Developer", "link": "https://superjob.ru/test"},
            {"id": "456", "profession": "Java Developer", "link": "https://superjob.ru/test2"},
        ]
    ...
    def test_convert_to_unified_format_with_salary(self):
        ...
        mock_salary = Mock()
        mock_salary.to_dict.return_value = {"from": 50000, "to": 100000, "currency": "RUR", "period": "месяц"}
    ...
    def test_convert_to_unified_format_with_month_period(self):
        ...
        mock_salary = Mock()
        mock_salary.to_dict.return_value = {"from": 50000, "to": 100000, "currency": "RUR", "period": "month"}
