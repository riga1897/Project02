...
class TestBaseJobAPI:
    ...
    def test_create_dedup_key_hh_no_salary(self):
        ...
        vacancy = {"name": "Python Developer", "employer": {"name": "Test Company"}, "salary": None}
    ...
    def test_create_dedup_key_sj_no_payment(self):
        ...
        vacancy = {"profession": "Java Developer", "firm_name": "Another Company"}
    ...
    def test_create_dedup_key_unknown_source(self):
        ...
        vacancy = {"title": "Some Title", "employer": {"name": "Some Company"}}
