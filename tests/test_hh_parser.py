...
class TestHHParser:
    ...
    def test_parse_vacancies_without_cache(self, parser):
        ...
        with (
            patch.object(parser, "_fetch_from_api", return_value=[{"id": "456"}]) as mock_fetch,
    ...
    def test_parse_items_success(self, parser):
        ...
        with (
            patch("src.vacancies.parsers.hh_parser.Vacancy.from_dict", return_value=mock_vacancy),
        ...
        raw_data = [
            {
                ...
                "name": "Test Job",
                "snippet": {"requirement": "Test requirement", "responsibility": "Test responsibility"},
            }
        ]
    ...
    def test_parse_items_with_non_dict_snippet(self, parser):
        ...
        raw_data = [{"id": "123", "name": "Test Job", "snippet": "string snippet"}]  # Не словарь
