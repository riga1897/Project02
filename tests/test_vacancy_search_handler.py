...
class TestVacancySearchHandler:
    ...
    @patch("src.ui_interfaces.vacancy_search_handler.VacancySearchHandler._display_duplicate_info")
    @patch("src.ui_interfaces.vacancy_search_handler.VacancySearchHandler._check_existing_vacancies")
    def test_handle_vacancies_preview_and_save_with_preview_and_save(
        self, mock_check, mock_display, mock_save, mock_paginate, mock_confirm, handler
    ):
    ...
    @patch("src.ui_interfaces.vacancy_search_handler.VacancySearchHandler._check_existing_vacancies")
    @patch("builtins.print")
    def test_handle_vacancies_preview_and_save_no_save(
        self, mock_print, mock_check, mock_display, mock_paginate, mock_confirm, handler
    ):
    ...
    @patch("src.ui_interfaces.vacancy_search_handler.VacancySearchHandler._check_existing_vacancies")
    @patch("builtins.print")
    def test_handle_vacancies_preview_and_save_no_new_vacancies(
        self, mock_print, mock_check, mock_display, mock_confirm, handler
    ):
    ...
    def test_display_duplicate_info_some_existing(self, mock_print, handler):
        ...
        expected_calls = [call("3 вакансий из 10 уже есть в базе данных."), call("Можно сохранить 7 новых вакансий.")]
    ...
    @patch("src.ui_interfaces.vacancy_search_handler.VacancySearchHandler._display_duplicate_info")
    @patch("src.ui_interfaces.vacancy_search_handler.VacancySearchHandler._check_existing_vacancies")
    def test_handle_vacancies_preview_format_vacancy_none_coverage(
        self, mock_check, mock_display, mock_confirm, mock_paginate, mock_formatter, handler
    ):
