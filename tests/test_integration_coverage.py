...
class TestIntegrationCoverage:
    ...
    def test_json_saver_integration_error_handling(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            test_vacancy = Vacancy(title="Test Job", url="https://example.com/job/1", vacancy_id="test_001")
    ...
    def test_vacancy_models_lines_121_122_185_228_230(self):
        ...
        invalid_date_data = {"title": "Test Job", "url": "https://example.com", "published_at": "invalid_date_format"}
