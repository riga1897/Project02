...
class TestAPIConnector:
    ...
    def test_connect_with_progress(self, mock_get, mock_sleep):
        ...
        with (
            patch.object(connector, "_init_progress") as mock_init,
            ...
            result = connector._APIConnector__connect(
                "http://test.com", {"param": "value"}, show_progress=True, progress_desc="Custom desc"
            )
    ...
    def test_connect_with_default_progress_desc(self, mock_get, mock_sleep):
        ...
        with (
            ...
            connector._APIConnector__connect("http://test.com/endpoint", {"param": "value"}, show_progress=True)
    ...
    def test_connect_always_closes_progress(self, mock_get, mock_sleep):
        ...
        with (
            patch.object(connector, "_init_progress"),
            patch.object(connector, "_update_progress"),
            patch.object(connector, "_close_progress") as mock_close,
        ):

            with pytest.raises(ConnectionError):
                connector._APIConnector__connect("http://test.com", {"param": "value"}, show_progress=True)
