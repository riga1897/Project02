...
class TestSJAPIConfig:
    ...
    def test_custom_initialization(self):
        ...
        config = SJAPIConfig(count=100, published=30, custom_params=custom_params)
    ...
    def test_get_params_default(self):
        ...
        expected = {"count": 500, "order_field": "date", "order_direction": "desc", "published": 15}
        assert params == expected

    def test_get_params_with_overrides(self):
        """Тест получения параметров с переопределением"""
        config = SJAPIConfig()
        params = config.get_params(count=200, order_field="salary", order_direction="asc", published=7)

        expected = {"count": 200, "order_field": "salary", "order_direction": "asc", "published": 7}
        assert params == expected
    ...
    def test_get_params_with_page(self):
        ...
        expected = {"count": 500, "order_field": "date", "order_direction": "desc", "published": 15, "page": 2}
        assert params == expected
    ...
    def test_get_params_with_town(self):
        ...
        expected = {"count": 500, "order_field": "date", "order_direction": "desc", "published": 15, "town": "Москва"}
        assert params == expected
    ...
    def test_get_params_all_optional_fields(self):
        ...
        config = SJAPIConfig()
        params = config.get_params(page=1, town="Санкт-Петербург", extra_param="test")
    ...
    def test_get_params_with_none_custom_params(self):
        ...
        expected = {"count": 500, "order_field": "date", "order_direction": "desc", "published": 15, "test": "value"}
        assert params == expected
