...
class TestHHAPIConfig:
    ...
    def test_custom_initialization(self):
        ...
        config = HHAPIConfig(area=1, per_page=100, only_with_salary=True, period=30, custom_params=custom_params)
    ...
    def test_get_params_default(self):
        ...
        expected = {"area": 113, "per_page": 50, "only_with_salary": False, "period": 15}
    ...
    def test_get_params_with_overrides(self):
        ...
        expected = {"area": 1, "per_page": 25, "only_with_salary": False, "period": 15, "custom_param": "test"}
        assert params == expected
    ...
    def test_get_hh_params_compatibility(self):
        ...
        expected = {"area": 1, "per_page": 50, "only_with_salary": False, "period": 15, "custom_param": "test"}
        assert params == expected
