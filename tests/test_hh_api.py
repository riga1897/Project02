...
class TestHeadHunterAPI:
    ...
    def mock_config(self):
        ...
        config.hh_config.get_params.return_value = {"area": 1, "per_page": 50, "only_with_salary": False}
    ...
    def test_validate_vacancy_valid(self, hh_api):
        ...
        vacancy = {"name": "Python Developer", "alternate_url": "https://hh.ru/vacancy/123"}
    ...
    def test_validate_vacancy_missing_name(self, hh_api):
        ...
        vacancy = {"alternate_url": "https://hh.ru/vacancy/123"}
    ...
    def test_validate_vacancy_empty_name(self, hh_api):
        ...
        vacancy = {"name": "", "alternate_url": "https://hh.ru/vacancy/123"}
    ...
    def test_get_vacancies_success(self, mock_logger, hh_api):
        ...
        initial_data = {"found": 100, "pages": 5}

        mock_page_data = [{"name": "Python Developer", "alternate_url": "https://hh.ru/vacancy/1"}]
    ...
    def test_deduplicate_vacancies(self, hh_api):
        ...
        vacancies = [{"id": "1", "name": "Python Developer"}, {"id": "2", "name": "Java Developer"}]
    ...
    def test_get_vacancies_with_deduplication(self, hh_api):
        ...
        mock_vacancies = [{"id": "1", "name": "Python Developer"}]
