...
class TestUnifiedAPI:
    ...
    def test_init(self):
        ...
        with (
            patch("src.api_modules.unified_api.HeadHunterAPI") as mock_hh,
    ...
    def test_deduplicate_cross_platform_no_duplicates(self, unified_api):
        ...
        vacancies = [
            {"name": "Python Developer", "employer": {"name": "Tech Corp"}, "salary": {"from": 100000, "to": 150000}},
            {"name": "Java Developer", "employer": {"name": "Other Corp"}, "salary": {"from": 120000, "to": 160000}},
        ]
    ...
    def test_deduplicate_cross_platform_mixed_formats(self, unified_api):
        ...
        vacancies = [
            {"name": "Python Developer", "employer": {"name": "Tech Corp"}, "salary": {"from": 100000, "to": 150000}},
            {"profession": "Python Developer", "firm_name": "Tech Corp", "payment_from": 100000, "payment_to": 150000},
        ]
        result = unified_api._deduplicate_cross_platform(vacancies)
        assert len(result) == 1
    ...
    def test_deduplicate_cross_platform_no_salary(self, unified_api):
        ...
        vacancy = {"name": "Python Developer", "employer": {"name": "Tech Corp"}}
        result = unified_api._deduplicate_cross_platform([vacancy])
        assert len(result) == 1

    def test_deduplicate_cross_platform_null_salary(self, unified_api):
        """Тест дедупликации с null зарплатой"""
        vacancy = {"name": "Python Developer", "employer": {"name": "Tech Corp"}, "salary": None}
        result = unified_api._deduplicate_cross_platform([vacancy])
        assert len(result) == 1
    ...
    def test_get_vacancies_from_sources_sj_only(self, unified_api):
        ...
        mock_sj_data = {"profession": "Python Developer", "firm_name": "Tech Corp", "payment_from": 100000}
        ...
        mock_unified_data = {"name": "Python Developer", "employer": {"name": "Tech Corp"}}
    ...
    def test_get_vacancies_from_sources_both_sources(self, unified_api):
        ...
        mock_hh_data = {"name": "Python Developer", "employer": {"name": "Tech Corp"}}
        mock_sj_data = {"profession": "Java Developer", "firm_name": "Other Corp"}
        ...
        mock_unified_sj_data = {"name": "Java Developer", "employer": {"name": "Other Corp"}}
