...
class TestVacancyFormatter:
    ...
    def test_format_vacancy_info_with_number(self):
        ...
        with patch.object(VacancyFormatter, '_build_vacancy_lines', return_value=["1.", "ID: 123", "Название: Python Developer"]) as mock_build:
    ...
    def test_format_salary_dict(self):
        ...
        with patch.object(VacancyFormatter, '_format_salary_dict', return_value="от 50000 до 100000 RUR") as mock_format:
    ...
    def test_build_vacancy_lines_full_info(self):
        ...
        with patch.object(VacancyFormatter, '_extract_responsibilities', return_value="Development tasks"), \
    ...
    def test_build_vacancy_lines_minimal_info(self):
        ...
        with patch.object(VacancyFormatter, '_extract_responsibilities', return_value=None), \
    ...
    def test_build_vacancy_lines_with_long_responsibilities(self):
        ...
        long_resp = "A" * 200
        with patch.object(VacancyFormatter, '_extract_responsibilities', return_value=long_resp), \
             patch.object(VacancyFormatter, '_extract_requirements', return_value=None), \
             patch.object(VacancyFormatter, '_extract_conditions', return_value=None):
