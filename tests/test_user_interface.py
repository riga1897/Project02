...
class TestUserInterface:
    ...
    def test_main_function_default_log_level(self, mock_print, mock_logging_config, 
                                           mock_load_env, mock_get_env_var, mock_ui_class):
    ...
    @patch('src.user_interface.logging.basicConfig')
    @patch('builtins.print')
    def test_main_function_debug_log_level(self, mock_print, mock_logging_config, 
                                         mock_load_env, mock_get_env_var, mock_ui_class):
    ...
    @patch('src.user_interface.logging.basicConfig')
    @patch('builtins.print')
    def test_main_function_error_log_level(self, mock_print, mock_logging_config, 
                                         mock_load_env, mock_get_env_var, mock_ui_class):
    ...
    @patch('src.user_interface.logging.basicConfig')
    @patch('builtins.print')
    def test_main_function_invalid_log_level(self, mock_print, mock_logging_config, 
                                           mock_load_env, mock_get_env_var, mock_ui_class):
    ...
    @patch('src.user_interface.logging.basicConfig')
    @patch('builtins.print')
    def test_main_function_lowercase_log_level(self, mock_print, mock_logging_config, 
                                             mock_load_env, mock_get_env_var, mock_ui_class):
    ...
    @patch('src.user_interface.logging.basicConfig')
    @patch('builtins.print')
    def test_main_function_ui_exception_handling(self, mock_print, mock_logging_config, 
                                                mock_load_env, mock_get_env_var, mock_ui_class):
