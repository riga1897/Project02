...
class TestSuperJobAPI:
    ...
    def mock_config(self):
        ...
        config.get_params.return_value = {"keyword": "test", "count": 100, "page": 0}
        return config
    ...
    def test_init_with_default_config(self):
        ...
        with (
            patch("src.api_modules.sj_api.EnvLoader") as mock_env,
    ...
    def test_validate_vacancy_valid(self, sj_api):
        ...
        vacancy = {"profession": "Python Developer", "link": "https://example.com/vacancy/123"}
    ...
    def test_validate_vacancy_missing_profession(self, sj_api):
        ...
        vacancy = {"link": "https://example.com/vacancy/123"}
        result = sj_api._validate_vacancy(vacancy)
    ...
    def test_get_vacancies_keyboard_interrupt(self, sj_api):
        ...
        with patch("src.api_modules.sj_api.logger") as mock_logger, patch("builtins.print") as mock_print:
            result = sj_api.get_vacancies("Python")
    ...
    def test_deduplicate_vacancies(self, sj_api):
        ...
        vacancies = [{"profession": "Dev1", "link": "link1"}, {"profession": "Dev2", "link": "link2"}]
    ...
    def test_get_vacancies_with_deduplication(self, sj_api):
        ...
        with (
            patch.object(sj_api, "get_vacancies") as mock_get,
